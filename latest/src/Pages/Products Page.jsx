...
const BADGE_COLORS = {
  "Organic": { bg: "#e8f5e9", color: "#2d7a3a" },
  "Fresh": { bg: "#e3f2fd", color: "#1565c0" },
  "Export Quality": { bg: "#fff3e0", color: "#e65100" },
  "Farm Fresh": { bg: "#e8f5e9", color: "#2d7a3a" },
  ...
  "Natural": { bg: "#f0faf2", color: "#388e3c" },
  ...
  "Pure & Natural": { bg: "#fff3e0", color: "#e65100" },
...
export default function ProductsPage() {
  ...
  return (
    <div style={{ fontFamily: "'Merriweather Sans', 'Segoe UI', sans-serif", color: "#1a2e1a", overflowX: "hidden" }}>
      ...
      {/* ─── CATEGORY TABS ─── */}
      <section style={{ background: "#fff", padding: "0 24px", borderBottom: "1px solid #f0f0f0", position: "sticky", top: 72, zIndex: 100 }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", gap: 0 }}>
          {PRODUCT_CATEGORIES.map(cat => (
            <button
              ...
              style={{
                padding: "20px 32px",
                border: "none", borderBottom: activeCategory === cat.id ? `3px solid ${cat.color}` : "3px solid transparent",
      ...
      {/* ─── PRODUCTS GRID ─── */}
      <section style={{ padding: "60px 24px 100px", background: "#f8fffe" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ marginBottom: 48, display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 24, flexWrap: "wrap" }}>
            ...
            <div style={{
              ...
              color: "#2d7a3a", fontWeight: 600, fontSize: 14,
              flexShrink: 0,
            }}>
            ...
            {filtered.map((product) => (
              <div
                ...
                style={{
                  ...
                  boxShadow: hovered === product.id ? "0 20px 60px rgba(0,0,0,0.1)" : "0 4px 20px rgba(0,0,0,0.05)",
              ...
              >
                ...
                <div style={{ height: 220, overflow: "hidden", position: "relative" }}>
                  ...
                  <div style={{
                    ...
                    background: product.stock === "In Stock" ? "rgba(45,122,58,0.9)" : product.stock === "Limited" ? "rgba(230,81,0,0.9)" : "rgba(100,100,100,0.9)",
                    color: "#fff",
                ...
                <div style={{ padding: "24px 24px 28px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
                    <div>
                      <div style={{ fontSize: 20, fontWeight: 800, color: activeCat.color }}>
                        {product.price}
                      </div>
          ...
          >
            <div style={{ display: "flex", gap: 16, marginBottom: 24, alignItems: "center" }}>
              ...
              <div>
                ...
                <div style={{ color: "#4caf50", fontWeight: 700, fontSize: 16 }}>{enquiry.price}</div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              ...
              <a href="mailto:info@rastriyakrishi.com.np" style={{
                display: "block", textAlign: "center",
                background: "#f0faf2", color: "#2d7a3a",
              ...
              <button onClick={() => setEnquiry(null)} style={{
